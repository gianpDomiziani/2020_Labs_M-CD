"""
Version B
Simulating a renewable powered charging station for electrical vehicles in a Goods Delivery service scenario
...
"""
# 0 to 7 - during night time only a small number of EVs circulate
# 7 to 13 - low frequency as many EVs will be waiting overnight waiting to deliver and thus will be departing early in the day
# 13 to 20 - high arrivals as most deliveries from the morning wiill be returning, but there may be short distance deliveries
# 20 to 23 - medium frequency as many EVs will want to recharge batteries before delivery the next day
...
# Plots utilization by hour
def util_bars(util_by_hour):
...
# First part of the question - Combinations of S_PV and N_BSS
